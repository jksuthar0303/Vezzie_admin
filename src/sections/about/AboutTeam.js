...
import { Box, Stack, Card, Button, Container, Typography, IconButton, Grid } from '@mui/material';
// _mock_
  ...
  return (
    <Container component={MotionViewport} sx={{ pb: 10 }}>
      <Grid container spacing={3}>
        <Grid item xs={12} md={6} lg={5} sx={{ pr: { md: 7 } }}>
          <m.div variants={varFade().inUp}>
            <Image
              alt="our office 1"
              src="/assets/images/about/vishnu.jpeg"
              sx={{
                borderRadius: 2,
              }}
            />
        ...
        <Grid item xs={12} md={6} lg={7}>
          ...
          <m.div variants={varFade().inUp}>
            ...
            >
              {`"Hey Dear, This Is "Vishnu Swami" I Hope You enjoy visiting our website"`}
            </Typography>
          </m.div>
        </Grid>
      </Grid>
